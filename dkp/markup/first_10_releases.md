...
Формат: одно решение — один блок.
- **сигнал**: точная цитата forward-guidance предложения
- **модальность**: необходимость / возможность / долженствование / условная оценка / отсутствует
- **вектор**: назван прямо (up/down/hold) / не назван / отложен
- **ограничители**: степень (более плавное, постепенно) / условия (в зависимости от) / нет

---

## 2021-07-23 | 5.5% → 6.5% (+100 б.п.)

**URL**: https://www.cbr.ru/press/pr/?file=23072021_133000key.htm

```
2021-07-23 | 6.50 | +100
сигнал: При развитии ситуации в соответствии с базовым прогнозом Банк России будет оценивать целесообразность дальнейшего повышения ключевой ставки на ближайших заседаниях.
модальность: TODO
вектор: TODO
ограничители: TODO
```
...
## 2021-12-17 | 7.5% → 8.5% (+100 б.п.)

**URL**: https://www.cbr.ru/press/pr/?file=17122021_133000key.htm

```
2021-12-17 | 8.50 | +100
сигнал: При развитии ситуации в соответствии с базовым прогнозом Банк России допускает возможность дальнейшего повышения ключевой ставки на ближайших заседаниях.
модальность: TODO
вектор: TODO
ограничители: TODO
```
...
## 2022-02-28 | 9.5% → 20.0% (+1050 б.п.)

**URL**: https://www.cbr.ru/press/pr/?file=28022022_094500key.htm

```
2022-02-28 | 20.00 | +1050
сигнал: Банк России будет принимать дальнейшие решения по ключевой ставке исходя из оценки рисков со стороны внешних и внутренних условий и реакции на них финансовых рынков и с учетом фактической и ожидаемой динамики инфляции относительно цели, развития экономики на прогнозном горизонте.
модальность: TODO
вектор: TODO
ограничители: TODO
```
...
## 2022-04-08 | 20.0% → 17.0% (-300 б.п.)

**URL**: https://www.cbr.ru/press/pr/?file=08042022_114000key.htm

```
2022-04-08 | 17.00 | -300
сигнал: Банк России будет принимать дальнейшие решения по ключевой ставке исходя из оценки рисков со стороны внешних и внутренних условий, реакции на них финансовых рынков и с учетом фактической и ожидаемой динамики инфляции относительно цели, развития экономики на прогнозном горизонте и допускает возможнос
модальность: TODO
вектор: TODO
ограничители: TODO
```
...
## 2025-06-06 | 21.0% → 20.0% (-100 б.п.)

**URL**: https://www.cbr.ru/press/pr/?file=06062025_133000key.htm

```
2025-06-06 | 20.00 | -100
сигнал: Банк России будет поддерживать такую жесткость денежно-кредитных условий, которая необходима для возвращения инфляции к цели в 2026 году.
модальность: TODO
вектор: TODO
ограничители: TODO
```
